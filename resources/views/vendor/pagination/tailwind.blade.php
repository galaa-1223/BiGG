        ...
        <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
            <div>
                <p class="text-sm text-gray-700 leading-5">
                    Нийт: <span class="font-medium">{{ $paginator->total() }}</span> ,
                    Харагдац: <span class="font-medium">{{ $paginator->firstItem() }}</span>-с <span class="font-medium">{{ $paginator->lastItem() }}</span>
                </p>
            </div>
