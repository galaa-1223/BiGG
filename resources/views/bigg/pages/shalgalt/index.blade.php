...
@section('subcontent')
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <a href="{{ route('bigg-shalgalt-add') }}" class="button text-white bg-theme-1 shadow-md mr-2">{{ $page_title }} оруулах</a>
        </div>
        <!-- BEGIN: Data List -->
                ...
                <tbody>
                        ...
                        <tr class="intro-x">
                            ...
                            <td class="text-center">
                                <a href="{{ route('bigg-shalgalt-asuult', $shalgalt->id) }}" class="py-1 px-2 rounded-full text-xs bg-theme-9 text-white cursor-pointer font-medium">
                                    Асуулт ( 0 )
                                </a>
                            </td>
    ...
    <div class="modal" id="delete-confirmation-modal">
        <div class="modal__content">
            <form action="{{ route('bigg-shalgalt-delete-ajax') }}" method="post">
            @csrf
